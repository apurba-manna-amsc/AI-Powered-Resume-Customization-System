...
class StreamlitResumeApp:
        ...
        with st.expander("🚀 Projects", expanded=True):
            ...
            for i, proj in enumerate(projects):
                ...
                if isinstance(description, list):
                    ...
                    description_text = str( description = proj.get("description", []))
    ...
    def run(self):
        ...
        with st.expander("📄 Resume Input", expanded=True):
            ...
            if resume_input_method == "Upload File":
                ...
                if uploaded_file:
                    ...
                    # print(f"📄 Extracted resume text: {resume_text[:200]}...")  # Print first 200 chars for debugging
        ...
        # Projects Input with improved GitHub section
